...
HD_PWD='D:/Xilinx/Project/experiment_six/DispNumber_sch/DispNumber_sch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DispNumber_sch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DispNumber_sch.tcl -notrace
