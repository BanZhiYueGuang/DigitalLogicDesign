...
HD_PWD='D:/Xilinx/Project/experiment_six/DispNumber_sch/DispNumber_sch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DispNumber_sch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DispNumber_sch.tcl
