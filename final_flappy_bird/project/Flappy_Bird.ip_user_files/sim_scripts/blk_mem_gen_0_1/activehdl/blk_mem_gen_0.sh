...
#
# Script generated by Vivado on Mon Jun 09 19:15:25 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/__Projects/VivadoProjects/Flappy_Bird/Flappy_Bird.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
