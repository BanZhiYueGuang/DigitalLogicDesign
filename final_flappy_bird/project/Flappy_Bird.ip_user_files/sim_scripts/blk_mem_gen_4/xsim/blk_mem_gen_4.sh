...
#
# Script generated by Vivado on Tue Jun 10 15:41:08 +0800 2025
...
export RDI_DATADIR="D:/vivado/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "blk_mem_gen_4.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_4 xil_defaultlib.blk_mem_gen_4 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/vivado/Vivado/2024.2/data/xsim"
  fi
